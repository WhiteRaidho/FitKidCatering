...
{
    public class RequireAllAttribute : AuthorizeAttribute
    {
        #region RequireAllAttribute()
        public RequireAllAttribute(params object[] permissions)
        {
            ...
            this.Policy = String.Format("RequireAll:{0}:{1}", types.First().FullName, permissions
                .Select(p =>
